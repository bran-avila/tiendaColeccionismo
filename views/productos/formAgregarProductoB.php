<div class=" menuFlotante container-fluid " id="menuFlotante">

<div  class="row justify-content-center">
            <form id="formProducto" class="col-md-6 col-lg-5 mt-4 needs-validation"  novalidate>
                <div class="card overflow-auto" style="height: 500px;">
                    <div class="card-body colorFomulario">
                        <h2 class="h4 text-center">Agregar Producto:</h2>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="contenedorFileImg">
                                <div class="input-div">
                                    <input class="input" name="urlPortadaImg" type="file" id="fileAgregar">
                        ...
                        <div class="row">
                            <button class="btn btn-success col-12 col-sm-6" type="submit">Guardar Producto</button>
                            <div class="col-sm-2"></div>
                            <button class="btn btn-secondary col-12 col-sm-3" type="button" id="btncerrar">Cerrar</button>
